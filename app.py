...
def add_task():
    ...
    # we must pass the categories variable as an arguement to the render
    # template function because we want to use the variable in our HTML
...
def get_categories():
    ...
    return render_template("categories.html", tasks=tasks, categories=categories)
...
def delete_category(category_id):
    ...
    flash("Category sccessfully deleted")
    return redirect(url_for('get_categories'))
